...
setwd("C:/Users/Luciano/Desktop/Cursos_Udemy/estatistica_com_R/Scripts_R")

#ABRIR ARQUIVO
enem2019 <- read.csv('enem_sp_2019.csv', sep = ",", encoding = "UTF-8")
...
View(names(enem2019))
# %in% verifica a intersecão em duas listas ou vetores.
...
#VERIFICAÇÃO DA TIPAGEM DOS ATRIBUTOS (Vari?veis)
...
# DATASET APENAS COM OS VESTIBULANDOS PRESENTES

vestibulandos_presentes <- vestibulandos %>% filter(vestibulandos$TP_PRESENCA_CN == 1 &
...
# SE FOSSE NECESSÁRIO EXCLUIR VALORES MISSING
